...
export function Onboarding() {
  ...
  const cohorts = [
    { id: 'GEN30', name: 'Generation 30 • Backend Focus', date: 'Started Jan 2026' },
    { id: 'GEN31', name: 'Generation 31 • Fullstack Master', date: 'Started March 2026' },
    { id: 'GEN32', name: 'Generation 32 • Web Foundations', date: 'Upcoming June 2026' },
  ];
        ...
        <div className="grid grid-cols-1 gap-4">
          {cohorts.map((cohort) => (
            <button
              ...
              className={`text-left p-6 rounded-[32px] border-2 transition-all group relative overflow-hidden ${
            ...
            >
              <div className="flex items-center justify-between relative z-10">
                ...
                <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${
                  selectedGen === cohort.id ? 'bg-indigo-600 text-white' : 'bg-slate-100 text-slate-300'
                }`}>
