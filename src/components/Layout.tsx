...
export function Layout({ admin = false }: { admin?: boolean; key?: React.Key }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex font-sans overflow-hidden h-screen">
      ...
      <aside 
        className={cn(
          "bg-white border-r border-slate-200 transition-all duration-300 ease-in-out z-20 h-full flex flex-col shrink-0",
        ...
        <div className="mt-auto p-4 space-y-2 border-t border-slate-100">
          {!admin && user?.role === 'admin' && (
            ...
            >
              ...
              {isSidebarOpen && <span>Admin Hub</span>}
            </Link>
          )}
          {admin && (
            <Link
            ...
            >
              ...
              {isSidebarOpen && <span>Student View</span>}
            </Link>
          )}
      ...
      <main className="flex-1 min-w-0 flex flex-col overflow-hidden">
        ...
        <header className="px-8 py-6 flex items-center justify-between shrink-0">
          ...
          <div className="flex items-center gap-4">
            {admin && (
              <div className="flex items-center gap-2 px-3 py-1.5 bg-white border border-slate-200 rounded-2xl shadow-sm">
            ...
            <div className="px-4 py-2 bg-white border border-slate-200 rounded-full flex items-center gap-2 text-[10px] font-black uppercase tracking-widest shadow-sm">
        ...
        {/* Page Content */}
        <div className="flex-1 p-8 overflow-y-auto no-scrollbar pt-0">
